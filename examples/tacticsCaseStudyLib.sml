...
struct
  ...
  open BasicProvers Defn HolKernel Parse Conv SatisfySimps
       Tactic monadsyntax boolTheory bossLib lcsymtacs;
...
val _ = LassieLib.def "follows from [ADD_COMM]" ["asm_rewrite_tac [ADD_COMM] THEN fs[ADD_COMM]"];
